...
Developers who wish to contribute code to be considered for inclusion in the MoonRay distribution must first complete the Contributor License Agreement and submit it to moonray@dreamworks.com, and don't
forget to include your GitHub username(s).
...
Once reviewed, scanned and tested, contributions will then appear in a future release and the original Pull Request will be closed.
Please have patience as we continue to work on improving this process.
