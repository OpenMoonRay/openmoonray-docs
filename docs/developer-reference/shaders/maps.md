...
The shading [State](https://github.com/dreamworksanimation/moonray/blob/release/lib/rendering/bvh/shading/State.h) provides the sample function with geometric data at the shading point.
...
See the [CheckerboardMap](https://github.com/dreamworksanimation/moonray/tree/release/dso/map/CheckerboardMap) for a relatively simple example.
