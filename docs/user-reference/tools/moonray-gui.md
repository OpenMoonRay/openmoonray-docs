...
<p>Starting with refplatvfx-2025, the `moonray_gui` executable will instead invoke the imgui-based <b>moonray_gui_v2</b>, documented <a href="../moonray-gui_v2">here</a>. </p>
</aside>
{: .warn-aside}
