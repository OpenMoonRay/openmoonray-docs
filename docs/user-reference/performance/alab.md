...
# Optimizing the [ALab Scene]({{ "/getting-started/test-scenes/" | absolute_url }})

---
The page notes ways to optimize rendering for the [ALab Scene]({{ "/getting-started/test-scenes/" | absolute_url }}).  It can serve as a useful example for optimizing scenes in general for rendering.  In particular, pay attention to:
...
[![Renderprofileviewer]({{ "/assets/images/user-reference/alab/renderProfileViewer.png" | absolute_url }})]({{ "/assets/images/user-reference/alab/renderProfileViewer.png" | absolute_url }})
...
Low quality uniform sampling
[![alab201-lo-xpu]({{ "/assets/images/user-reference/alab/out_096loUnifXpu0.png" | absolute_url }})]({{ "/assets/images/user-reference/alab/out_096loUnifXpu0.png" | absolute_url }})


Medium quality uniform sampling
[![alab201-md-xpu]({{ "/assets/images/user-reference/alab/out_096mdUnifXpu0.png" | absolute_url }})]({{ "/assets/images/user-reference/alab/out_096mdUnifXpu0.png" | absolute_url }})


High quality uniform sampling
[![alab201-hi-xpu]({{ "/assets/images/user-reference/alab/out_096hiUnifXpu0.png" | absolute_url }})]({{ "/assets/images/user-reference/alab/out_096hiUnifXpu0.png" | absolute_url }})

Low quality adaptive sampling
[![alab201-lo-xpu]({{ "/assets/images/user-reference/alab/out_096loAdptXpu0.png" | absolute_url }})]({{ "/assets/images/user-reference/alab/out_096loAdptXpu0.png" | absolute_url }})

Medium quality adaptive sampling
[![alab201-md-xpu]({{ "/assets/images/user-reference/alab/out_096mdAdptXpu0.png" | absolute_url }})]{{ "/assets/images/user-reference/alab/out_096mdAdptXpu0.png" | absolute_url }})


High quality adaptive sampling
[![alab201-hi-xpu]({{ "/assets/images/user-reference/alab/out_096hiAdptXpu0.png" | absolute_url }})]({{ "/assets/images/user-reference/alab/out_096hiAdptXpu0.png" | absolute_url }})
