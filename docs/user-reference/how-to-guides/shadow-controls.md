...
![Max Shadow Distance Example]({{ "/assets/images/user-reference/how-to-guides/shadow-controls/max_shadow_distance.gif" | absolute_url }})
...
![Clear Radius Example]({{ "/assets/images/user-reference/how-to-guides/shadow-controls/clear_radius.gif" | absolute_url }})
...
![Combined Behavior Example]({{ "/assets/images/user-reference/how-to-guides/shadow-controls/combined.gif" | absolute_url }})
