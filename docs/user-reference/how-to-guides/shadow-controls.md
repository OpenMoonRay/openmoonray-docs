...
<figure>
    <video controls loop muted>
      <source src="{{ "/assets/images/user-reference/how-to-guides/shadow-controls/max_shadow_distance.mp4" | absolute_url }}" alt="Max Shadow Distance Example">
    </video>
</figure>
...
<figure>
    <video controls loop muted>
      <source src="{{ "/assets/images/user-reference/how-to-guides/shadow-controls/clear_radius.mp4" | absolute_url }}" alt="Clear Radius Example">
    </video>
</figure>
...
<figure>
    <video controls loop muted>
      <source src="{{ "/assets/images/user-reference/how-to-guides/shadow-controls/combined.mp4" | absolute_url }}" alt="Combined Behavior Example">
    </video>
</figure>
