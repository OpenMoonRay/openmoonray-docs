...
---
# Variance AOVs
A <span class="define">variance AOV</span> is a special AOV that measures the pixel variance of another AOV. It is always a buffer of single floats, as opposed to, for example, RGB or XYZ. 
