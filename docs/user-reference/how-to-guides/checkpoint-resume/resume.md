...
Resume rendering allows more sample data to be added to a previously computed image.
This is supported in `moonray` running in "resume rendering" mode, and is not supported in `moonray_gui`.
