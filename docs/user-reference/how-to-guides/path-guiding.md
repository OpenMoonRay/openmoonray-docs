...
This feature should be used only when needed. Basic path tracing performs well in most cases. When
...
- Sample clamping can lead to inconsistent lighting results, especially when compared to non-path guided results. Do not
