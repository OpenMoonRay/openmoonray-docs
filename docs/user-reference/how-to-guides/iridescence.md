...
![Color Wheel]({{"/assets/images/user-reference/how-to-guides/iridescence/color_wheel.png" | absolute_url}})
...
| Metallic    | Dielectric    |
| ----------- | ----------- |
| ![Metallic]({{"/assets/images/user-reference/how-to-guides/iridescence/metal.jpg" | absolute_url}}) | ![Solid Dielectric]({{"/assets/images/user-reference/how-to-guides/iridescence/solid_dielectric.jpg" | absolute_url}}) |
...
| ----------- | ----------- |
| ![Clearcoat Bending Off]({{"/assets/images/user-reference/how-to-guides/iridescence/clearcoat_bending_off.jpg" | absolute_url}}) | ![Clearcoat Bending]({{"/assets/images/user-reference/how-to-guides/iridescence/clearcoat_bending.jpg" | absolute_url}}) |
