...
{%-include overview.html data=site.data.user-reference.scene-objects.normal-maps.ProjectPlanarNormalMap-%}
{%-include image-gallery.html images=site.data.user-reference.scene-objects.normal-maps.ProjectPlanarNormalMap.gallery data=site.data.user-reference.scene-objects.normal-maps.ProjectPlanarNormalMap-%}
{%-include see-also.html links=site.data.user-reference.scene-objects.normal-maps.ProjectPlanarNormalMap.links-%}
---
## Attribute Reference
...
{%-include example.html data=site.data.user-reference.scene-objects.normal-maps.ProjectPlanarNormalMap-%}