---
title: Transform Normal Map
---
# TransformNormalMap
{%-include overview.html data=site.data.scene-classes.normal-maps.TransformNormalMap-%}
...
{%-include example.html data=site.data.scene-classes.normal-maps.TransformNormalMap-%}