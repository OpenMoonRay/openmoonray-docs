...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">Method to specify grid resolution of baked density grid.  Choices are:<br>&emsp;&emsp;default: For shaders that are bound to vdb volumes, use vdb resolution.<br>&emsp;&emsp;&emsp;&emsp;For shaders that are bounds to mesh geometries use 100 divisions<br>&emsp;&emsp;divisions: Specify number of divisions.<br>&emsp;&emsp;voxel size: Specify voxel size.</p>
