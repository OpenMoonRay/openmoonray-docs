...
---
# WireframeMap
{%-include overview.html data=site.data.user-reference.scene-objects.maps.WireframeMap-%}
{%-include image-gallery.html images=site.data.user-reference.scene-objects.maps.WireframeMap.gallery data=site.data.user-reference.scene-objects.maps.WireframeMap-%}
{%-include see-also.html links=site.data.user-reference.scene-objects.maps.WireframeMap.links-%}
---
## Attribute Reference
...
{%-include example.html data=site.data.user-reference.scene-objects.maps.WireframeMap-%}