...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.maps.ClampMap.attributes.clamp.videos data=site.data.user-reference.scene-objects.maps.ClampMap-%}
    ...
    <p class="scene-class-type">
      ...
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.maps.ClampMap.attributes.clamp_max.videos data=site.data.user-reference.scene-objects.maps.ClampMap-%}
    ...
    <p class="scene-class-type">
      ...
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.maps.ClampMap.attributes.clamp_min.videos data=site.data.user-reference.scene-objects.maps.ClampMap-%}
    ...
    <p class="scene-class-type">
      ...
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.maps.ClampMap.attributes.input.videos data=site.data.user-reference.scene-objects.maps.ClampMap-%}
