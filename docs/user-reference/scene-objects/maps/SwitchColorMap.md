...
---
# SwitchColorMap
{%-include overview.html data=site.data.user-reference.scene-objects.maps.SwitchColorMap-%}
{%-include image-gallery.html images=site.data.user-reference.scene-objects.maps.SwitchColorMap.gallery data=site.data.user-reference.scene-objects.maps.SwitchColorMap-%}
{%-include see-also.html links=site.data.user-reference.scene-objects.maps.SwitchColorMap.links-%}
---
## Attribute Reference
...
{%-include example.html data=site.data.user-reference.scene-objects.maps.SwitchColorMap-%}