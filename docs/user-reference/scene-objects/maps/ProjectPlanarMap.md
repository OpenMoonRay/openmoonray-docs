...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.maps.ProjectPlanarMap.attributes.black_outside_projection.videos data=site.data.user-reference.scene-objects.maps.ProjectPlanarMap-%}
    ...
    <p class="scene-class-type">
      ...
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.maps.ProjectPlanarMap.attributes.project_on_back_faces.videos data=site.data.user-reference.scene-objects.maps.ProjectPlanarMap-%}
    ...
    <p class="scene-class-type">
      ...
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.maps.ProjectPlanarMap.attributes.projection_mode.videos data=site.data.user-reference.scene-objects.maps.ProjectPlanarMap-%}
    ...
    <p class="scene-class-type">
      ...
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.maps.ProjectPlanarMap.attributes.use_reference_space.videos data=site.data.user-reference.scene-objects.maps.ProjectPlanarMap-%}
