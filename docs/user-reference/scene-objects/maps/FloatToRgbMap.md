...
{%-include image-gallery.html images=site.data.user-reference.scene-objects.maps.FloatToRgbMap.gallery data=site.data.user-reference.scene-objects.maps.FloatToRgbMap-%}
{%-include see-also.html links=site.data.user-reference.scene-objects.maps.FloatToRgbMap.links-%}
---
## Attribute Reference
...
{%-include example.html data=site.data.user-reference.scene-objects.maps.FloatToRgbMap-%}