...
---
# ImageMap
{%-include overview.html data=site.data.scene-classes.maps.ImageMap-%}
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.blur.links heading=4-%}
    </p>
    <h3>mip_bias</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.mip_bias.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.num_blur_samples.links heading=4-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.TMI.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.TMI_control_enabled.links heading=4-%}
    </p>
    <h3>contrast</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.contrast.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.contrast_enabled.links heading=4-%}
    </p>
    <h3>gain</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.gain.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.gain_offset_enabled.links heading=4-%}
    </p>
    <h3>gamma_adjust</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.gamma_adjust.links heading=4-%}
    </p>
    <h3>gamma_enabled</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.gamma_enabled.links heading=4-%}
    </p>
    <h3>offset_adjust</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.offset_adjust.links heading=4-%}
    </p>
    <h3>saturation</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.saturation.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.saturation_enabled.links heading=4-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.alpha_only.links heading=4-%}
    </p>
    <h3>default_color</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.default_color.links heading=4-%}
    </p>
    <h3>gamma</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.gamma.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.input_texture_coordinates.links heading=4-%}
    </p>
    <h3>offset</h3>
    <p class="scene-class-type">
      <b>Vec2f</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.offset.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.rotation_angle.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.rotation_center.links heading=4-%}
    </p>
    <h3>scale</h3>
    <p class="scene-class-type">
      <b>Vec2f</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.scale.links heading=4-%}
    </p>
    <h3>texture</h3>
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.texture.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.texture_coordinates.links heading=4-%}
    </p>
    <h3>udim_files</h3>
    <p class="scene-class-type">
      <b>StringVector</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.udim_files.links heading=4-%}
    </p>
    <h3>udim_max_v</h3>
    <p class="scene-class-type">
      <b>Int</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.udim_max_v.links heading=4-%}
    </p>
    <h3>udim_values</h3>
    <p class="scene-class-type">
      <b>IntVector</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.udim_values.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.use_default_color_when_missing.links heading=4-%}
    </p>
    <h3>wrap_around</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ImageMap.attributes.wrap_around.links heading=4-%}
    </p>
  </p>
</details>
</div>
