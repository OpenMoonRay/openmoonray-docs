...
---
# ToonDisplayFilter
{%-include overview.html data=site.data.user-reference.scene-objects.display-filters.ToonDisplayFilter-%}
{%-include image-gallery.html images=site.data.user-reference.scene-objects.display-filters.ToonDisplayFilter.gallery data=site.data.user-reference.scene-objects.display-filters.ToonDisplayFilter-%}
{%-include see-also.html links=site.data.user-reference.scene-objects.display-filters.ToonDisplayFilter.links-%}
---
## Attribute Reference
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      <br>
          ...
          &nbsp;&nbsp;1 = &ldquo;Sobel&rdquo;<br>
          &nbsp;&nbsp;2 = &ldquo;Laplacian&rdquo;<br>
...
{%-include example.html data=site.data.user-reference.scene-objects.display-filters.ToonDisplayFilter-%}