---
title: Measured Material
---
# MeasuredMaterial
{%-include overview.html data=site.data.scene-classes.materials.MeasuredMaterial-%}
{%-include image-gallery.html images=site.data.scene-classes.materials.MeasuredMaterial.gallery data=site.data.scene-classes.materials.MeasuredMaterial-%}
{%-include see-also.html links=site.data.scene-classes.materials.MeasuredMaterial.links-%}
---
## Attribute Reference
