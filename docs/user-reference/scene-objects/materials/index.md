...
### Thin Geometry
Use <span class="define">thin geometry</span> if you want the behavior of a thin surface, like a bubble or a balloon filled with _air_. This will essentially let light pass through without bending. It correctly handles <span class="define">IORs</span> (index of refraction) when exiting the surface via back-sided polygons.   
