...
---
# MacroFlakeMaterial
{%-include overview.html data=site.data.scene-classes.materials.MacroFlakeMaterial-%}
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.materials.MacroFlakeMaterial.attributes.input_normal.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.materials.MacroFlakeMaterial.attributes.input_normal_dial.links heading=4-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.materials.MacroFlakeMaterial.attributes.metallic_color.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.materials.MacroFlakeMaterial.attributes.metallic_edge_color.links heading=4-%}
    </p>
    <h3>roughness</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%-include see-also.html links=site.data.scene-classes.materials.MacroFlakeMaterial.attributes.roughness.links heading=4-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.materials.MacroFlakeMaterial.attributes.background_material.links heading=4-%}
    </p>
    <h3>diffuse_mode</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%-include see-also.html links=site.data.scene-classes.materials.MacroFlakeMaterial.attributes.diffuse_mode.links heading=4-%}
    </p>
    <h3>extra_aovs</h3>
    <p class="scene-class-type">
      <b>Map</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.materials.MacroFlakeMaterial.attributes.extra_aovs.links heading=4-%}
    </p>
    <h3>fuzz_mode</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%-include see-also.html links=site.data.scene-classes.materials.MacroFlakeMaterial.attributes.fuzz_mode.links heading=4-%}
    </p>
    <h3>is_additive</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.materials.MacroFlakeMaterial.attributes.is_additive.links heading=4-%}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.materials.MacroFlakeMaterial.attributes.label.links heading=4-%}
    </p>
    <h3>mask</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%-include see-also.html links=site.data.scene-classes.materials.MacroFlakeMaterial.attributes.mask.links heading=4-%}
    </p>
    <h3>priority</h3>
    <p class="scene-class-type">
      <b>Int</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.materials.MacroFlakeMaterial.attributes.priority.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.materials.MacroFlakeMaterial.attributes.specular_background_mode.links heading=4-%}
    </p>
  </p>
</details>
</div>
