...
---
# DwaSwitchMaterial
{%-include overview.html data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
{%-include image-gallery.html images=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.gallery data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
{%-include see-also.html links=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.links-%}
---
## Attribute Reference
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.fallback_bssrdf.videos data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
    ...
    <p class="scene-class-type">
      ...
      {%-include image-gallery.html images=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.sss_trace_set.images data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.sss_trace_set.videos data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
      {%-include see-also.html links=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.sss_trace_set.links heading=4-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include image-gallery.html images=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.choice.images data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.choice.videos data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
      {%-include see-also.html links=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.choice.links heading=4-%}
    </p>
    <h3>extra_aovs</h3>
    <p class="scene-class-type">
      <b>Map</b>
      ...
      {%-include image-gallery.html images=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.extra_aovs.images data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.extra_aovs.videos data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
      {%-include see-also.html links=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.extra_aovs.links heading=4-%}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%-include image-gallery.html images=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.label.images data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.label.videos data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
      {%-include see-also.html links=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.label.links heading=4-%}
    </p>
    <h3>material0</h3>
    <p class="scene-class-type">
    ...
    <p class="scene-class-type">
      ...
      {%-include image-gallery.html images=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.priority.images data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.priority.videos data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
      {%-include see-also.html links=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.priority.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include image-gallery.html images=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.record_reflected_cryptomatte.images data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.record_reflected_cryptomatte.videos data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
      {%-include see-also.html links=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.record_reflected_cryptomatte.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include image-gallery.html images=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.record_refracted_cryptomatte.images data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.record_refracted_cryptomatte.videos data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}
      {%-include see-also.html links=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial.attributes.record_refracted_cryptomatte.links heading=4-%}
    </p>
  </p>
</details>
</div>
{%-include example.html data=site.data.user-reference.scene-objects.materials.DwaSwitchMaterial-%}