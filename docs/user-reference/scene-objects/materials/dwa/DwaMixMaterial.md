...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include image-gallery.html images=site.data.user-reference.scene-objects.materials.DwaMixMaterial.attributes.fallback_prevent_light_culling.images data=site.data.user-reference.scene-objects.materials.DwaMixMaterial-%}
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.materials.DwaMixMaterial.attributes.fallback_prevent_light_culling.videos data=site.data.user-reference.scene-objects.materials.DwaMixMaterial-%}
      {%-include see-also.html links=site.data.user-reference.scene-objects.materials.DwaMixMaterial.attributes.fallback_prevent_light_culling.links heading=4-%}
    </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include image-gallery.html images=site.data.user-reference.scene-objects.materials.DwaMixMaterial.attributes.record_reflected_cryptomatte.images data=site.data.user-reference.scene-objects.materials.DwaMixMaterial-%}
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.materials.DwaMixMaterial.attributes.record_reflected_cryptomatte.videos data=site.data.user-reference.scene-objects.materials.DwaMixMaterial-%}
      {%-include see-also.html links=site.data.user-reference.scene-objects.materials.DwaMixMaterial.attributes.record_reflected_cryptomatte.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include image-gallery.html images=site.data.user-reference.scene-objects.materials.DwaMixMaterial.attributes.record_refracted_cryptomatte.images data=site.data.user-reference.scene-objects.materials.DwaMixMaterial-%}
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.materials.DwaMixMaterial.attributes.record_refracted_cryptomatte.videos data=site.data.user-reference.scene-objects.materials.DwaMixMaterial-%}
      {%-include see-also.html links=site.data.user-reference.scene-objects.materials.DwaMixMaterial.attributes.record_refracted_cryptomatte.links heading=4-%}
    </p>
