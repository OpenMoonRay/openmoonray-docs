...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.disable_indices.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.evaluation_frame.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.instance_level.links heading=4-%}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.label.links heading=4-%}
    </p>
    <h3>method</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.method.links heading=4-%}
    </p>
    <h3>node_xform</h3>
    <p class="scene-class-type">
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.orientations.links heading=4-%}
    </p>
    <h3>positions</h3>
    <p class="scene-class-type">
      <b>Vec3fVector</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.positions.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.primitive_attributes.links heading=4-%}
    </p>
    <h3>ray_epsilon</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.ray_epsilon.links heading=4-%}
    </p>
    <h3>ref_indices</h3>
    <p class="scene-class-type">
      <b>IntVector</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.ref_indices.links heading=4-%}
    </p>
    <h3>references</h3>
    <p class="scene-class-type">
      <b>Geometry Vector</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.references.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.reverse_normals.links heading=4-%}
    </p>
    <h3>scales</h3>
    <p class="scene-class-type">
      <b>Vec3fVector</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.scales.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.shadow_exclusion_mappings.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.shadow_ray_epsilon.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.shadow_receiver_label.links heading=4-%}
    </p>
    <h3>side_type</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.side_type.links heading=4-%}
    </p>
    <h3>static</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.static.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.use_reference_attributes.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.use_reference_xforms.links heading=4-%}
    </p>
    <h3>velocities</h3>
    <p class="scene-class-type">
      <b>Vec3fVector</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.velocities.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.visible_diffuse_reflection.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.visible_diffuse_transmission.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.visible_glossy_reflection.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.visible_glossy_transmission.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.visible_in_camera.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.visible_mirror_reflection.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.visible_mirror_transmission.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.visible_shadow.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.visible_volume.links heading=4-%}
    </p>
    <h3>xform_list</h3>
    <p class="scene-class-type">
      <b>Mat4dVector</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.geometry.RdlInstancerGeometry.attributes.xform_list.links heading=4-%}
    </p>
  </p>
</details>
</div>
