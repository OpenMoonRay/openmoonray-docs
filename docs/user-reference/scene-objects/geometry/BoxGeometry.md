...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include image-gallery.html images=site.data.user-reference.scene-objects.geometry.BoxGeometry.attributes.use_local_camera_motion_blur.images data=site.data.user-reference.scene-objects.geometry.BoxGeometry-%}
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.geometry.BoxGeometry.attributes.use_local_camera_motion_blur.videos data=site.data.user-reference.scene-objects.geometry.BoxGeometry-%}
      {%-include see-also.html links=site.data.user-reference.scene-objects.geometry.BoxGeometry.attributes.use_local_camera_motion_blur.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%-include image-gallery.html images=site.data.user-reference.scene-objects.geometry.BoxGeometry.attributes.use_local_motion_blur.images data=site.data.user-reference.scene-objects.geometry.BoxGeometry-%}
      {%-include video-gallery.html videos=site.data.user-reference.scene-objects.geometry.BoxGeometry.attributes.use_local_motion_blur.videos data=site.data.user-reference.scene-objects.geometry.BoxGeometry-%}
      {%-include see-also.html links=site.data.user-reference.scene-objects.geometry.BoxGeometry.attributes.use_local_motion_blur.links heading=4-%}
    </p>
  </p>
</details>
</div>
