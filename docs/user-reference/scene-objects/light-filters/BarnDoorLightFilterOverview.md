...
| <img src="{{ "/assets/images/user-reference/scene-objects/light-filters/BarnDoorLightFilter/barndoor_analytical.png" | absolute_url }}" width=245><img src="{{ "/assets/images/user-reference/scene-objects/light-filters/BarnDoorLightFilter/exampleAnalyticalPerspective.jpg" | absolute_url }}" width=245>  | <img src="{{ "/assets/images/user-reference/scene-objects/light-filters/BarnDoorLightFilter/barndoor_physical.png" | absolute_url }}" width=245><img src="{{ "/assets/images/user-reference/scene-objects/light-filters/BarnDoorLightFilter/examplePhysicalPerspective.jpg" | absolute_url }}" width=245>  | <img src="{{ "/assets/images/user-reference/scene-objects/light-filters/BarnDoorLightFilter/exampleModeOff.jpg" | absolute_url }}" width=245> |
|------------------------------------------------------|------------------------------------------------------|------------------------------------------------------|
...
| <img src="{{ "/assets/images/user-reference/scene-objects/light-filters/BarnDoorLightFilter/barndoor_perspective_projection.png" | absolute_url }}" width=245><img src="{{ "/assets/images/user-reference/scene-objects/light-filters/BarnDoorLightFilter/exampleAnalyticalPerspective.jpg" | absolute_url }}" width=245>  | <img src="{{ "/assets/images/user-reference/scene-objects/light-filters/BarnDoorLightFilter/barndoor_orthographic_projection.png" | absolute_url }}" width=245><img src="{{ "/assets/images/user-reference/scene-objects/light-filters/BarnDoorLightFilter/exampleAnalyticalOrthographic.jpg" | absolute_url }}" width=245>  | <img src="{{ "/assets/images/user-reference/scene-objects/light-filters/BarnDoorLightFilter/exampleModeOff.jpg" | absolute_url }}" width=245> |
|------------------------------------------------------|------------------------------------------------------|------------------------------------------------------|
