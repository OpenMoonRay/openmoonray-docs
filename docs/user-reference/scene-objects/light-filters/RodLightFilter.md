...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      <b>Rgb</b>
      default: [ 0, 0, 0 ]
      <p class="scene-class-comments">Filter color. Scales the light within the volume. For each color channel: 0 means full shadow, 1 means no shadow.</p>
    ...
    <p class="scene-class-type">
      <b>Float</b>
      default: 1.0
      <p class="scene-class-comments">Fades the filter effect. 0 means no effect (like having no filter). 1 means full effect.</p>
    ...
    <p class="scene-class-type">
      <b>Float</b>
      default: 1.0
      <p class="scene-class-comments">Scalar for multiplying the color. 0 means black, 1 means no change.</p>
