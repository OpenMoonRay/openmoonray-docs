...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectSphericalMap.attributes.TRS_order.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectSphericalMap.attributes.projection_matrix.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectSphericalMap.attributes.projection_mode.links-%}
    </p>
    <h3>projector</h3>
    <p class="scene-class-type">
      <b>Node</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectSphericalMap.attributes.projector.links-%}
    </p>
    <h3>rotate</h3>
    <p class="scene-class-type">
      <b>Vec3d</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectSphericalMap.attributes.rotate.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectSphericalMap.attributes.rotation_order.links-%}
    </p>
    <h3>scale</h3>
    <p class="scene-class-type">
      <b>Vec3d</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectSphericalMap.attributes.scale.links-%}
    </p>
    <h3>translate</h3>
    <p class="scene-class-type">
      <b>Vec3d</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectSphericalMap.attributes.translate.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectSphericalMap.attributes.use_reference_space.links-%}
    </p>
  </p>
</details>
</div>