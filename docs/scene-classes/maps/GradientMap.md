...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.GradientMap.attributes.symmetric.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.GradientMap.attributes.symmetric_center.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.GradientMap.attributes.falloff_bias.links-%}
    </p>
    <h3>falloff_end</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.GradientMap.attributes.falloff_end.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.GradientMap.attributes.falloff_end_intensity.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.GradientMap.attributes.falloff_exponent.links-%}
    </p>
    <h3>falloff_start</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.GradientMap.attributes.falloff_start.links-%}
    </p>
    <h3>falloff_type</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.GradientMap.attributes.falloff_type.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.GradientMap.attributes.color_A.links-%}
    </p>
    <h3>color_B</h3>
    <p class="scene-class-type">
      <b>Rgb</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.GradientMap.attributes.color_B.links-%}
    </p>
    <h3>end</h3>
    <p class="scene-class-type">
      <b>Vec3f</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.GradientMap.attributes.end.links-%}
    </p>
    <h3>object</h3>
    <p class="scene-class-type">
      <b>Geometry</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.GradientMap.attributes.object.links-%}
    </p>
    <h3>space</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.GradientMap.attributes.space.links-%}
    </p>
    <h3>start</h3>
    <p class="scene-class-type">
      <b>Vec3f</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.GradientMap.attributes.start.links-%}
    </p>
  </p>
</details>
</div>