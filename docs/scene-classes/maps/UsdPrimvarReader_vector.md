...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.UsdPrimvarReader_vectorattributes.fallback.images.
          path=image_path
      %}
    </p>
    <h3>varname</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.UsdPrimvarReader_vectorattributes.varname.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.UsdPrimvarReader_vectorattributes.warn_when_unavailable.images.
          path=image_path
      %}
    </p>
  </p>
