...
{%assign image_path=site.data.scene-classes.maps.UsdPrimvarReader_vector.image_path%}
{%if site.data.scene-classes.maps.UsdPrimvarReader_vector.gallery-%}
---
## Gallery
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.UsdPrimvarReader_vector.attributes.fallback.images.
          path=image_path
      %}
    </p>
    <h3>varname</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.UsdPrimvarReader_vector.attributes.varname.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.UsdPrimvarReader_vector.attributes.warn_when_unavailable.images.
          path=image_path
      %}
    </p>
  </p>
