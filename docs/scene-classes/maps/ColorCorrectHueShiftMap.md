...
{%-include overview.html data=site.data.scene-classes.maps.ColorCorrectHueShiftMap-%}
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ColorCorrectHueShiftMap.attributes.hue_shift.links heading=4-%}
    </p>
    <h3>input</h3>
    <p class="scene-class-type">
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ColorCorrectHueShiftMap.attributes.input.links heading=4-%}
    </p>
    <h3>mix</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ColorCorrectHueShiftMap.attributes.mix.links heading=4-%}
    </p>
    <h3>on</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%-include see-also.html links=site.data.scene-classes.maps.ColorCorrectHueShiftMap.attributes.on.links heading=4-%}
    </p>
  </p>
</details>
</div>