...
---
# AttributeMap
{%assign image_path=site.data.scene-classes.maps.AttributeMap.image_path%}
{%if site.data.scene-classes.maps.AttributeMap.gallery-%}
---
## Gallery
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.AttributeMap.attributes.primitive_attribute_name.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.AttributeMap.attributes.primitive_attribute_type.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.AttributeMap.attributes.color.images.
          path=image_path
      %}
    </p>
    <h3>default_value</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.AttributeMap.attributes.default_value.images.
          path=image_path
      %}
    </p>
    <h3>map_type</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.AttributeMap.attributes.map_type.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.AttributeMap.attributes.warn_when_unavailable.images.
          path=image_path
      %}
    </p>
  </p>
