...
# NoiseMap_v2
---
{%assign image_dir=site.data.scene-classes.maps.NoiseMap_v2.image_dir%}
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.time
          image_dir=image_dir
      %}
    </p>
    <h3>use_4D_noise</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.use_4D_noise
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.bias
          image_dir=image_dir
      %}
    </p>
    <h3>gain</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.gain
          image_dir=image_dir
      %}
    </p>
    <h3>invert</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.invert
          image_dir=image_dir
      %}
    </p>
    <h3>smoothstep</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.smoothstep
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.use_smoothstep
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.flow_advection_rate
          image_dir=image_dir
      %}
    </p>
    <h3>flow_angle</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.flow_angle
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.camera
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.input_texture_coordinates
          image_dir=image_dir
      %}
    </p>
    <h3>object_space</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.object_space
          image_dir=image_dir
      %}
    </p>
    <h3>space</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.space
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.rotation
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.rotation_order
          image_dir=image_dir
      %}
    </p>
    <h3>scale</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.scale
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.transformation_order
          image_dir=image_dir
      %}
    </p>
    <h3>translation</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.translation
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.amplitude
          image_dir=image_dir
      %}
    </p>
    <h3>color</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.color
          image_dir=image_dir
      %}
    </p>
    <h3>color_A</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.color_A
          image_dir=image_dir
      %}
    </p>
    <h3>color_B</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.color_B
          image_dir=image_dir
      %}
    </p>
    <h3>distortion</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.distortion
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.distortion_noise_type
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.frequency_multiplier
          image_dir=image_dir
      %}
    </p>
    <h3>lacunarity</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.lacunarity
          image_dir=image_dir
      %}
    </p>
    <h3>max_level</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.max_level
          image_dir=image_dir
      %}
    </p>
    <h3>noise_type</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.noise_type
          image_dir=image_dir
      %}
    </p>
    <h3>persistence</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.persistence
          image_dir=image_dir
      %}
    </p>
    <h3>seed</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2.seed
          image_dir=image_dir
      %}
    </p>
  </p>
