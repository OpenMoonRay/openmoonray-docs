...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.time.images.
          path=image_path
      %}
    </p>
    <h3>use_4D_noise</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.use_4D_noise.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.bias.images.
          path=image_path
      %}
    </p>
    <h3>gain</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.gain.images.
          path=image_path
      %}
    </p>
    <h3>invert</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.invert.images.
          path=image_path
      %}
    </p>
    <h3>smoothstep</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.smoothstep.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.use_smoothstep.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.flow_advection_rate.images.
          path=image_path
      %}
    </p>
    <h3>flow_angle</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.flow_angle.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.camera.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.input_texture_coordinates.images.
          path=image_path
      %}
    </p>
    <h3>object_space</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.object_space.images.
          path=image_path
      %}
    </p>
    <h3>space</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.space.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.rotation.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.rotation_order.images.
          path=image_path
      %}
    </p>
    <h3>scale</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.scale.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.transformation_order.images.
          path=image_path
      %}
    </p>
    <h3>translation</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.translation.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.amplitude.images.
          path=image_path
      %}
    </p>
    <h3>color</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.color.images.
          path=image_path
      %}
    </p>
    <h3>color_A</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.color_A.images.
          path=image_path
      %}
    </p>
    <h3>color_B</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.color_B.images.
          path=image_path
      %}
    </p>
    <h3>distortion</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.distortion.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.distortion_noise_type.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.frequency_multiplier.images.
          path=image_path
      %}
    </p>
    <h3>lacunarity</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.lacunarity.images.
          path=image_path
      %}
    </p>
    <h3>max_level</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.max_level.images.
          path=image_path
      %}
    </p>
    <h3>noise_type</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.noise_type.images.
          path=image_path
      %}
    </p>
    <h3>persistence</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.persistence.images.
          path=image_path
      %}
    </p>
    <h3>seed</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.NoiseMap_v2attributes.seed.images.
          path=image_path
      %}
    </p>
  </p>
