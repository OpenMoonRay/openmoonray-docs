...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UVTransformMap.attributes.offset.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UVTransformMap.attributes.rotation_angle.links-%}
    </p>
    <h3>rotation_axis</h3>
    <p class="scene-class-type">
      <b>Vec3f</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UVTransformMap.attributes.rotation_axis.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UVTransformMap.attributes.rotation_center.links-%}
    </p>
    <h3>scale</h3>
    <p class="scene-class-type">
      <b>Vec2f</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UVTransformMap.attributes.scale.links-%}
    </p>
    <h3>space</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UVTransformMap.attributes.space.links-%}
    </p>
  </p>
</details>
</div>