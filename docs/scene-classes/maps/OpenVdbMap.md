...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.attributes.show_active_field.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.attributes.default_value.images.
          path=image_path
      %}
    </p>
    <h3>grid_name</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.attributes.grid_name.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.attributes.input_texture_coordinates.images.
          path=image_path
      %}
    </p>
    <h3>interpolation</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.attributes.interpolation.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.attributes.openvdb_geometry.images.
          path=image_path
      %}
    </p>
    <h3>show_warnings</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.attributes.show_warnings.images.
          path=image_path
      %}
    </p>
    <h3>texture</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.attributes.texture.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.attributes.texture_coordinates.images.
          path=image_path
      %}
    </p>
    <h3>vdb_source</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.attributes.vdb_source.images.
          path=image_path
      %}
    </p>
  </p>
