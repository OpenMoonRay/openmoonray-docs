...
# OpenVdbMap
---
{%assign image_dir=site.data.scene-classes.maps.OpenVdbMap.image_dir%}
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.show_active_field
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.default_value
          image_dir=image_dir
      %}
    </p>
    <h3>grid_name</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.grid_name
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.input_texture_coordinates
          image_dir=image_dir
      %}
    </p>
    <h3>interpolation</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.interpolation
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.openvdb_geometry
          image_dir=image_dir
      %}
    </p>
    <h3>show_warnings</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.show_warnings
          image_dir=image_dir
      %}
    </p>
    <h3>texture</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.texture
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.texture_coordinates
          image_dir=image_dir
      %}
    </p>
    <h3>vdb_source</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap.vdb_source
          image_dir=image_dir
      %}
    </p>
  </p>
