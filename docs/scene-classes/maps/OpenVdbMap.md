  ...
  <p>
    ...
    <p>
      <b>Geometry</b>
        ...
        <p class="scene-class-attr-comment">The OpenVdbGeometry object from which to retrieve the .vdb filename and transform when 'vdb source' is set to 'from OpenVdbGeometry'</p>
