...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.contrast_b.links-%}
    </p>
    <h3>contrast_g</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.contrast_g.links-%}
    </p>
    <h3>contrast_r</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.contrast_r.links-%}
    </p>
    <h3>gain_b</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.gain_b.links-%}
    </p>
    <h3>gain_g</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.gain_g.links-%}
    </p>
    <h3>gain_r</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.gain_r.links-%}
    </p>
    <h3>gamma_b</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.gamma_b.links-%}
    </p>
    <h3>gamma_g</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.gamma_g.links-%}
    </p>
    <h3>gamma_r</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.gamma_r.links-%}
    </p>
    <h3>offset_b</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.offset_b.links-%}
    </p>
    <h3>offset_g</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.offset_g.links-%}
    </p>
    <h3>offset_r</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.offset_r.links-%}
    </p>
    <h3>saturation_b</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.saturation_b.links-%}
    </p>
    <h3>saturation_g</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.saturation_g.links-%}
    </p>
    <h3>saturation_r</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.saturation_r.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.use_per_channel_contrast.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.use_per_channel_gain_offset.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.use_per_channel_gamma.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.use_per_channel_saturation.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.TMI.links-%}
    </p>
    <h3>TMI_enabled</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.TMI_enabled.links-%}
    </p>
    <h3>clamp</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.clamp.links-%}
    </p>
    <h3>clamp_max</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.clamp_max.links-%}
    </p>
    <h3>clamp_min</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.clamp_min.links-%}
    </p>
    <h3>contrast</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.contrast.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.contrast_enabled.links-%}
    </p>
    <h3>gain</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.gain.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.gain_offset_enabled.links-%}
    </p>
    <h3>gamma</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.gamma.links-%}
    </p>
    <h3>gamma_enabled</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.gamma_enabled.links-%}
    </p>
    <h3>hue_shift</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.hue_shift.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.hue_shift_enabled.links-%}
    </p>
    <h3>input</h3>
    <p class="scene-class-type">
      <b>Rgb</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.input.links-%}
    </p>
    <h3>mix</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.mix.links-%}
    </p>
    <h3>offset</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.offset.links-%}
    </p>
    <h3>on</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.on.links-%}
    </p>
    <h3>saturation</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.saturation.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectMap.attributes.saturation_enabled.links-%}
    </p>
  </p>
</details>
</div>