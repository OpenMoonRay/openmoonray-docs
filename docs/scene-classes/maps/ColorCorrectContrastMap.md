...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectContrastMap.attributes.contrast.links-%}
    </p>
    <h3>contrast_b</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectContrastMap.attributes.contrast_b.links-%}
    </p>
    <h3>contrast_g</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectContrastMap.attributes.contrast_g.links-%}
    </p>
    <h3>contrast_r</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectContrastMap.attributes.contrast_r.links-%}
    </p>
    <h3>input</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectContrastMap.attributes.input.links-%}
    </p>
    <h3>mix</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectContrastMap.attributes.mix.links-%}
    </p>
    <h3>on</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectContrastMap.attributes.on.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectContrastMap.attributes.use_per_channel_contrast.links-%}
    </p>
  </p>
</details>
</div>