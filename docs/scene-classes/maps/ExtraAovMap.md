...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ExtraAovMap.attributes.color.links-%}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ExtraAovMap.attributes.label.links-%}
    </p>
    <h3>post_scatter</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ExtraAovMap.attributes.post_scatter.links-%}
    </p>
  </p>
</details>
</div>