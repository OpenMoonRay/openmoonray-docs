...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectPlanarMap.attributes.TRS_order.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectPlanarMap.attributes.black_outside_projection.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectPlanarMap.attributes.project_on_back_faces.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectPlanarMap.attributes.projection_matrix.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectPlanarMap.attributes.projection_mode.links-%}
    </p>
    <h3>projector</h3>
    <p class="scene-class-type">
      <b>Node</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectPlanarMap.attributes.projector.links-%}
    </p>
    <h3>rotate</h3>
    <p class="scene-class-type">
      <b>Vec3d</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectPlanarMap.attributes.rotate.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectPlanarMap.attributes.rotation_order.links-%}
    </p>
    <h3>scale</h3>
    <p class="scene-class-type">
      <b>Vec3d</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectPlanarMap.attributes.scale.links-%}
    </p>
    <h3>translate</h3>
    <p class="scene-class-type">
      <b>Vec3d</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectPlanarMap.attributes.translate.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ProjectPlanarMap.attributes.use_reference_space.links-%}
    </p>
  </p>
</details>
</div>