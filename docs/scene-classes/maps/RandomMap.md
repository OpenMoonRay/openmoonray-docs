...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RandomMap.attributes.input.links-%}
    </p>
    <h3>monochrome</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RandomMap.attributes.monochrome.links-%}
    </p>
    <h3>output_max</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RandomMap.attributes.output_max.links-%}
    </p>
    <h3>output_min</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RandomMap.attributes.output_min.links-%}
    </p>
    <h3>seed</h3>
    <p class="scene-class-type">
      <b>Int</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RandomMap.attributes.seed.links-%}
    </p>
  </p>
</details>
</div>