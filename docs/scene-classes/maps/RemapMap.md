...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.clamp_max_RGB.links-%}
    </p>
    <h3>clamp_min_RGB</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.clamp_min_RGB.links-%}
    </p>
    <h3>input_max_RGB</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.input_max_RGB.links-%}
    </p>
    <h3>input_min_RGB</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.input_min_RGB.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.midpoint_bias_RGB.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.output_max_RGB.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.output_min_RGB.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.clamp.links-%}
    </p>
    <h3>clamp_RGB</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.clamp_RGB.links-%}
    </p>
    <h3>clamp_max</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.clamp_max.links-%}
    </p>
    <h3>clamp_min</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.clamp_min.links-%}
    </p>
    <h3>input</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.input.links-%}
    </p>
    <h3>input_max</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.input_max.links-%}
    </p>
    <h3>input_min</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.input_min.links-%}
    </p>
    <h3>midpoint_bias</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.midpoint_bias.links-%}
    </p>
    <h3>output_max</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.output_max.links-%}
    </p>
    <h3>output_min</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.output_min.links-%}
    </p>
    <h3>remap_method</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.RemapMap.attributes.remap_method.links-%}
    </p>
  </p>
</details>
</div>