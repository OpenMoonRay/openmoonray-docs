...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UsdUVTexture.attributes.bias.links-%}
    </p>
    <h3>fallback</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UsdUVTexture.attributes.fallback.links-%}
    </p>
    <h3>file</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UsdUVTexture.attributes.file.links-%}
    </p>
    <h3>scale</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UsdUVTexture.attributes.scale.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UsdUVTexture.attributes.sourceColorSpace.links-%}
    </p>
    <h3>st</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UsdUVTexture.attributes.st.links-%}
    </p>
    <h3>udim_files</h3>
    <p class="scene-class-type">
      <b>StringVector</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UsdUVTexture.attributes.udim_files.links-%}
    </p>
    <h3>udim_max_v</h3>
    <p class="scene-class-type">
      <b>Int</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UsdUVTexture.attributes.udim_max_v.links-%}
    </p>
    <h3>udim_values</h3>
    <p class="scene-class-type">
      <b>IntVector</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UsdUVTexture.attributes.udim_values.links-%}
    </p>
    <h3>wrapS</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UsdUVTexture.attributes.wrapS.links-%}
    </p>
    <h3>wrapT</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.UsdUVTexture.attributes.wrapT.links-%}
    </p>
  </p>
</details>
</div>