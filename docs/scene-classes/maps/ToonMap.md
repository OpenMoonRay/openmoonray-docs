...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ToonMap.attributes.crease_color.links-%}
    </p>
    <h3>crease_scale</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ToonMap.attributes.crease_scale.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ToonMap.attributes.crease_threshold.links-%}
    </p>
    <h3>fill_color</h3>
    <p class="scene-class-type">
      <b>Rgb</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ToonMap.attributes.fill_color.links-%}
    </p>
    <h3>mode</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ToonMap.attributes.mode.links-%}
    </p>
    <h3>outline_color</h3>
    <p class="scene-class-type">
      <b>Rgb</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ToonMap.attributes.outline_color.links-%}
    </p>
    <h3>outline_scale</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ToonMap.attributes.outline_scale.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ToonMap.attributes.outline_threshold.links-%}
    </p>
  </p>
</details>
</div>