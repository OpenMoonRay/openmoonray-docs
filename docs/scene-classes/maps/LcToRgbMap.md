...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.LcToRgbMap.attributes.input_color.links-%}
    </p>
    <h3>target_color</h3>
    <p class="scene-class-type">
      <b>Rgb</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.LcToRgbMap.attributes.target_color.links-%}
    </p>
  </p>
</details>
</div>