...
---
# OpenVdbMap_v2
{%assign image_path=site.data.scene-classes.maps.OpenVdbMap_v2.images.path%}
{%if site.data.scene-classes.maps.OpenVdbMap_v2.images.gallery-%}
---
## Gallery
{% include image-gallery.html
    images=site.data.scene-classes.maps.OpenVdbMap_v2.images.gallery
    path=image_path
%}
{%endif%}
{%if site.data.scene-classes.maps.OpenVdbMap_v2.links-%}
---
## See Also
{%for link in site.data.scene-classes.maps.OpenVdbMap_v2.links-%}
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap_v2.images.attributes.show_active_field
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap_v2.images.attributes.default_value
          path=image_path
      %}
    </p>
    <h3>grid_name</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap_v2.images.attributes.grid_name
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap_v2.images.attributes.input_texture_coordinates
          path=image_path
      %}
    </p>
    <h3>interpolation</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap_v2.images.attributes.interpolation
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap_v2.images.attributes.openvdb_geometry
          path=image_path
      %}
    </p>
    <h3>show_warnings</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap_v2.images.attributes.show_warnings
          path=image_path
      %}
    </p>
    <h3>texture</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap_v2.images.attributes.texture
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap_v2.images.attributes.texture_coordinates
          path=image_path
      %}
    </p>
    <h3>vdb_source</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.maps.OpenVdbMap_v2.images.attributes.vdb_source
          path=image_path
      %}
    </p>
  </p>
