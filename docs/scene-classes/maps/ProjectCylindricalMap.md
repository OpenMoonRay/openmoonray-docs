  ...
  <p>
    ...
    <p>
      <b>Bool</b>
        ...
        <p class="scene-class-attr-comment">enables projection on surfaces with inward facing normals</p>
    ...
    <p>
      <b>Bool</b>
        ...
        <p class="scene-class-attr-comment">enables projection on surfaces with outward facing normals</p>
