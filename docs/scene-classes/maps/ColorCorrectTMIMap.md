...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectTMIMap.attributes.TMI.links-%}
    </p>
    <h3>input</h3>
    <p class="scene-class-type">
      <b>Rgb</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectTMIMap.attributes.input.links-%}
    </p>
    <h3>mix</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectTMIMap.attributes.mix.links-%}
    </p>
    <h3>on</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.maps.ColorCorrectTMIMap.attributes.on.links-%}
    </p>
  </p>
</details>
</div>