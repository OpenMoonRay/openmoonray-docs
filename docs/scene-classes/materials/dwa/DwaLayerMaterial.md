...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.blend_color_space.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_bssrdf.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_clearcoat_use_bending.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_outer_specular_model.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_specular_model.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_thin_geometry.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_toon_specular_model.links-%}
    </p>
    <h3>sss_trace_set</h3>
    <p class="scene-class-type">
      <b>Traceset</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.sss_trace_set.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_glitter_LOD_quality.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_glitter_debug_mode.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_glitter_layering_mode.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_glitter_randomness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_glitter_seed.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_glitter_space.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_glitter_style_A_frequency.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_glitter_style_B_frequency.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_glitter_texture_A.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.fallback_glitter_texture_B.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.extra_aovs.links-%}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.label.links-%}
    </p>
    <h3>mask</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.mask.links-%}
    </p>
    <h3>material_A</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.material_A.links-%}
    </p>
    <h3>material_B</h3>
    <p class="scene-class-type">
      <b>Dwabaselayerable</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.material_B.links-%}
    </p>
    <h3>priority</h3>
    <p class="scene-class-type">
      <b>Int</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaLayerMaterial.attributes.priority.links-%}
    </p>
  </p>
</details>
</div>