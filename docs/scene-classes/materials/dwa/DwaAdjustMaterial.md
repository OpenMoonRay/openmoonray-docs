...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.adjust_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.adjust_presence.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.adjust_roughness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.adjust_specular.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.casts_caustics.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.disable_clearcoat.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.disable_diffuse.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.disable_specular.links-%}
    </p>
    <h3>thin_geometry</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.thin_geometry.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.emission.links-%}
    </p>
    <h3>emission_mode</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.emission_mode.links-%}
    </p>
    <h3>extra_aovs</h3>
    <p class="scene-class-type">
      <b>Map</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.extra_aovs.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.input_material.links-%}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.label.links-%}
    </p>
    <h3>mix</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.mix.links-%}
    </p>
    <h3>on</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.on.links-%}
    </p>
    <h3>priority</h3>
    <p class="scene-class-type">
      <b>Int</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaAdjustMaterial.attributes.priority.links-%}
    </p>
  </p>
</details>
</div>