...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.specular.links-%}
    </p>
    <h3>sss_trace_set</h3>
    <p class="scene-class-type">
      <b>Traceset</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.sss_trace_set.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.clearcoat.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.clearcoat_attenuation_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.clearcoat_bending.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.clearcoat_model.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.clearcoat_normal_dial.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.clearcoat_refractive_index.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.clearcoat_roughness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.clearcoat_thickness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.independent_clearcoat_normal.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.show_clearcoat.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.use_independent_clearcoat_normal.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.casts_caustics.links-%}
    </p>
    <h3>presence</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.presence.links-%}
    </p>
    <h3>thin_geometry</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.thin_geometry.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.albedo.links-%}
    </p>
    <h3>bssrdf</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.bssrdf.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.diffuse_roughness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.diffuse_transmission.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.diffuse_transmission_blending_behavior.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.diffuse_transmission_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.enable_sss_input_normal.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.resolve_self_intersections.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.scattering_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.scattering_radius.links-%}
    </p>
    <h3>show_diffuse</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.show_diffuse.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.emission.links-%}
    </p>
    <h3>show_emission</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.show_emission.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.fuzz.links-%}
    </p>
    <h3>fuzz_albedo</h3>
    <p class="scene-class-type">
      <b>Rgb</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.fuzz_albedo.links-%}
    </p>
    <h3>fuzz_normal</h3>
    <p class="scene-class-type">
      <b>33554432</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.fuzz_normal.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.fuzz_normal_dial.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.fuzz_roughness.links-%}
    </p>
    <h3>show_fuzz</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.show_fuzz.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.use_absorbing_fuzz_fibers.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_LOD_quality.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_approximate_for_secondary_rays.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_color_A.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_color_B.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_color_hue_variation.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_color_saturation_variation.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_color_value_variation.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_compensate_reference_space_deformation.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_debug_mode.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_density.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_jitter.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_layering_mode.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_randomness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_roughness_A.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_roughness_B.links-%}
    </p>
    <h3>glitter_seed</h3>
    <p class="scene-class-type">
      <b>Int</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_seed.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_size_A.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_size_B.links-%}
    </p>
    <h3>glitter_space</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_space.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_style_A_frequency.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_style_B_frequency.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_texture_A.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_texture_B.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.glitter_texture_orientation_randomness.links-%}
    </p>
    <h3>show_glitter</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.show_glitter.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.iridescence.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.iridescence_apply_to.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.iridescence_at_0_incidence.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.iridescence_at_90_incidence.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.iridescence_color_control.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.iridescence_colors.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.iridescence_exponent.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.iridescence_flip_hue_direction.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.iridescence_interpolations.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.iridescence_positions.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.iridescence_primary_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.iridescence_ramp_interpolation_mode.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.iridescence_secondary_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.iridescence_thickness.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.input_normal.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.input_normal_dial.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.normal_AA_dial.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.normal_AA_strategy.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.anisotropy.links-%}
    </p>
    <h3>metallic</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.metallic.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.metallic_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.metallic_edge_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.refractive_index.links-%}
    </p>
    <h3>roughness</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.roughness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.shading_tangent.links-%}
    </p>
    <h3>show_specular</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.show_specular.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.specular_model.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.dispersion_abbe_number.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.independent_transmission_refractive_index.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.independent_transmission_roughness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.show_transmission.links-%}
    </p>
    <h3>transmission</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.transmission.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.transmission_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.use_dispersion.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.use_independent_transmission_refractive_index.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.use_independent_transmission_roughness.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.extra_aovs.links-%}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.label.links-%}
    </p>
    <h3>priority</h3>
    <p class="scene-class-type">
      <b>Int</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.dwa.DwaBaseMaterial.attributes.priority.links-%}
    </p>
  </p>
</details>
</div>