...
---
{%assign image_dir=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.image_dir%}
<div class="scene-class">
{% include image-gallery.html
    images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.gallery
    image_dir=image_dir
%}
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.specular
          image_dir=image_dir
      %}
    </p>
    <h3>sss_trace_set</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.sss_trace_set
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.clearcoat
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.clearcoat_attenuation_color
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.clearcoat_bending
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.clearcoat_model
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.clearcoat_normal_dial
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.clearcoat_refractive_index
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.clearcoat_roughness
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.clearcoat_thickness
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.independent_clearcoat_normal
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.show_clearcoat
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.use_independent_clearcoat_normal
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.casts_caustics
          image_dir=image_dir
      %}
    </p>
    <h3>presence</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.presence
          image_dir=image_dir
      %}
    </p>
    <h3>thin_geometry</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.thin_geometry
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.albedo
          image_dir=image_dir
      %}
    </p>
    <h3>bssrdf</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.bssrdf
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.diffuse_roughness
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.diffuse_transmission
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.diffuse_transmission_blending_behavior
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.diffuse_transmission_color
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.enable_sss_input_normal
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.resolve_self_intersections
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.scattering_color
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.scattering_radius
          image_dir=image_dir
      %}
    </p>
    <h3>show_diffuse</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.show_diffuse
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.emission
          image_dir=image_dir
      %}
    </p>
    <h3>show_emission</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.show_emission
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.fuzz
          image_dir=image_dir
      %}
    </p>
    <h3>fuzz_albedo</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.fuzz_albedo
          image_dir=image_dir
      %}
    </p>
    <h3>fuzz_normal</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.fuzz_normal
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.fuzz_normal_dial
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.fuzz_roughness
          image_dir=image_dir
      %}
    </p>
    <h3>show_fuzz</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.show_fuzz
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.use_absorbing_fuzz_fibers
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_LOD_quality
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_approximate_for_secondary_rays
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_color_A
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">base flake color (use physical metallic color values)</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_color_B
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_color_hue_variation
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_color_saturation_variation
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_color_value_variation
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_compensate_reference_space_deformation
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_debug_mode
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_density
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_jitter
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_layering_mode
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_randomness
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_roughness_A
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">specular roughness of individual flakes (0 makes flakes mirror-like)</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_roughness_B
          image_dir=image_dir
      %}
    </p>
    <h3>glitter_seed</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_seed
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_size_A
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">size of the flakes.  Apparent flake size may vary based on how much the flake spheres intersect the surface</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_size_B
          image_dir=image_dir
      %}
    </p>
    <h3>glitter_space</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_space
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_style_A_frequency
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">0 implies none of this style, 1 implies all the flakes will get this style</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_style_B_frequency
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_texture_A
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">filename that points to a texture .exr or .tx file (must be mip-mapped and tiled with maketx).</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_texture_B
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.glitter_texture_orientation_randomness
          image_dir=image_dir
      %}
    </p>
    <h3>show_glitter</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.show_glitter
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.iridescence
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.iridescence_apply_to
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.iridescence_at_0_incidence
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.iridescence_at_90_incidence
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.iridescence_color_control
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.iridescence_colors
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.iridescence_exponent
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.iridescence_flip_hue_direction
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.iridescence_interpolations
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.iridescence_positions
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.iridescence_primary_color
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.iridescence_ramp_interpolation_mode
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.iridescence_secondary_color
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.iridescence_thickness
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.input_normal
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.input_normal_dial
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.normal_AA_dial
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.normal_AA_strategy
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.anisotropy
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.refractive_index
          image_dir=image_dir
      %}
    </p>
    <h3>roughness</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.roughness
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.shading_tangent
          image_dir=image_dir
      %}
    </p>
    <h3>show_specular</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.show_specular
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.specular_model
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.extra_aovs
          image_dir=image_dir
      %}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.label
          image_dir=image_dir
      %}
    </p>
    <h3>priority</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.priority
          image_dir=image_dir
      %}
    </p>
  </p>
