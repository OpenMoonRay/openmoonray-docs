...
{%assign image_path=site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.image_path%}
{%if site.data.scene-classes.materials.dwa.DwaSolidDielectricMaterial.gallery-%}
---
## Gallery
