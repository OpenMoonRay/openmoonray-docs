...
---
{%assign image_dir=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.image_dir%}
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.specular
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.clearcoat
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.clearcoat_attenuation_color
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.clearcoat_bending
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.clearcoat_model
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.clearcoat_normal_dial
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.clearcoat_refractive_index
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.clearcoat_roughness
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.clearcoat_thickness
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.independent_clearcoat_normal
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.show_clearcoat
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.use_independent_clearcoat_normal
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.casts_caustics
          image_dir=image_dir
      %}
    </p>
    <h3>presence</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.presence
          image_dir=image_dir
      %}
    </p>
    <h3>thin_geometry</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.thin_geometry
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.emission
          image_dir=image_dir
      %}
    </p>
    <h3>show_emission</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.show_emission
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.fuzz
          image_dir=image_dir
      %}
    </p>
    <h3>fuzz_albedo</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.fuzz_albedo
          image_dir=image_dir
      %}
    </p>
    <h3>fuzz_normal</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.fuzz_normal
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.fuzz_normal_dial
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.fuzz_roughness
          image_dir=image_dir
      %}
    </p>
    <h3>show_fuzz</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.show_fuzz
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.use_absorbing_fuzz_fibers
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.iridescence
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.iridescence_apply_to
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.iridescence_at_0_incidence
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.iridescence_at_90_incidence
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.iridescence_color_control
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.iridescence_colors
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.iridescence_exponent
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.iridescence_flip_hue_direction
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.iridescence_interpolations
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.iridescence_positions
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.iridescence_primary_color
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.iridescence_ramp_interpolation_mode
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.iridescence_secondary_color
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.iridescence_thickness
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.input_normal
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.input_normal_dial
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.normal_AA_dial
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.normal_AA_strategy
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.anisotropy
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.refractive_index
          image_dir=image_dir
      %}
    </p>
    <h3>roughness</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.roughness
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.shading_tangent
          image_dir=image_dir
      %}
    </p>
    <h3>show_specular</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.show_specular
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.specular_model
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.dispersion_abbe_number
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.independent_transmission_refractive_index
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.independent_transmission_roughness
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.show_transmission
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.transmission_color
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.use_dispersion
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.use_independent_transmission_refractive_index
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.use_independent_transmission_roughness
          image_dir=image_dir
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.extra_aovs
          image_dir=image_dir
      %}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.label
          image_dir=image_dir
      %}
    </p>
    <h3>priority</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaRefractiveMaterial.priority
          image_dir=image_dir
      %}
    </p>
  </p>
