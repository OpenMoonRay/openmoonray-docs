...
---
# DwaFabricMaterial
{%assign image_path=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.path%}
{%if site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.gallery-%}
---
## Gallery
{% include image-gallery.html
    images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.gallery
    path=image_path
%}
{%endif%}
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.casts_caustics
          path=image_path
      %}
    </p>
    <h3>presence</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.presence
          path=image_path
      %}
    </p>
    <h3>thin_geometry</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.thin_geometry
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.albedo
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.diffuse_roughness
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.diffuse_transmission
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.diffuse_transmission_blending_behavior
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.diffuse_transmission_color
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.fabric_diffuse_scattering
          path=image_path
      %}
    </p>
    <h3>show_diffuse</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.show_diffuse
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.emission
          path=image_path
      %}
    </p>
    <h3>show_emission</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.show_emission
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.show_specular
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.use_UVs_for_thread_direction
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.use_independent_weft_attributes
          path=image_path
      %}
    </p>
    <h3>warp_color</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.warp_color
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.warp_roughness
          path=image_path
      %}
    </p>
    <h3>weft_color</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.weft_color
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.weft_roughness
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.fuzz
          path=image_path
      %}
    </p>
    <h3>fuzz_albedo</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.fuzz_albedo
          path=image_path
      %}
    </p>
    <h3>fuzz_normal</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.fuzz_normal
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.fuzz_normal_dial
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.fuzz_roughness
          path=image_path
      %}
    </p>
    <h3>show_fuzz</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.show_fuzz
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.use_absorbing_fuzz_fibers
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_LOD_quality
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_approximate_for_secondary_rays
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_color_A
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">base flake color (use physical metallic color values)</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_color_B
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_color_hue_variation
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_color_saturation_variation
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_color_value_variation
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_compensate_reference_space_deformation
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_debug_mode
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_density
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_jitter
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_layering_mode
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_randomness
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_roughness_A
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">specular roughness of individual flakes (0 makes flakes mirror-like)</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_roughness_B
          path=image_path
      %}
    </p>
    <h3>glitter_seed</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_seed
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_size_A
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">size of the flakes.  Apparent flake size may vary based on how much the flake spheres intersect the surface</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_size_B
          path=image_path
      %}
    </p>
    <h3>glitter_space</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_space
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_style_A_frequency
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">0 implies none of this style, 1 implies all the flakes will get this style</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_style_B_frequency
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_texture_A
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">filename that points to a texture .exr or .tx file (must be mip-mapped and tiled with maketx).</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_texture_B
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.glitter_texture_orientation_randomness
          path=image_path
      %}
    </p>
    <h3>show_glitter</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.show_glitter
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.input_normal
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.input_normal_dial
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.warp_thread_coverage
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.warp_thread_direction
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.warp_thread_elevation
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.extra_aovs
          path=image_path
      %}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.label
          path=image_path
      %}
    </p>
    <h3>priority</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaFabricMaterial.images.attributes.priority
          path=image_path
      %}
    </p>
  </p>
