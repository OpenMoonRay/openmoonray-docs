...
---
# DwaMetalMaterial
{%assign image_path=site.data.scene-classes.materials.dwa.DwaMetalMaterial.image_path%}
{%if site.data.scene-classes.materials.dwa.DwaMetalMaterial.gallery-%}
---
## Gallery
{% include image-gallery.html
    images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.gallery
    path=image_path
%}
{%endif%}
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.specular.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.clearcoat.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.clearcoat_attenuation_color.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.clearcoat_bending.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.clearcoat_model.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.clearcoat_normal_dial.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.clearcoat_refractive_index.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.clearcoat_roughness.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.clearcoat_thickness.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.independent_clearcoat_normal.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.show_clearcoat.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.use_independent_clearcoat_normal.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.casts_caustics.images.
          path=image_path
      %}
    </p>
    <h3>presence</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.presence.images.
          path=image_path
      %}
    </p>
    <h3>thin_geometry</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.thin_geometry.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.emission.images.
          path=image_path
      %}
    </p>
    <h3>show_emission</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.show_emission.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.fuzz.images.
          path=image_path
      %}
    </p>
    <h3>fuzz_albedo</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.fuzz_albedo.images.
          path=image_path
      %}
    </p>
    <h3>fuzz_normal</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.fuzz_normal.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.fuzz_normal_dial.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.fuzz_roughness.images.
          path=image_path
      %}
    </p>
    <h3>show_fuzz</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.show_fuzz.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.use_absorbing_fuzz_fibers.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_LOD_quality.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_approximate_for_secondary_rays.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_color_A.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">base flake color (use physical metallic color values)</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_color_B.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_color_hue_variation.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_color_saturation_variation.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_color_value_variation.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_compensate_reference_space_deformation.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_debug_mode.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_density.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_jitter.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_layering_mode.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_randomness.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_roughness_A.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">specular roughness of individual flakes (0 makes flakes mirror-like)</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_roughness_B.images.
          path=image_path
      %}
    </p>
    <h3>glitter_seed</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_seed.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_size_A.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">size of the flakes.  Apparent flake size may vary based on how much the flake spheres intersect the surface</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_size_B.images.
          path=image_path
      %}
    </p>
    <h3>glitter_space</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_space.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_style_A_frequency.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">0 implies none of this style, 1 implies all the flakes will get this style</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_style_B_frequency.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_texture_A.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      <p class="scene-class-comments">filename that points to a texture .exr or .tx file (must be mip-mapped and tiled with maketx).</p>
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_texture_B.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.glitter_texture_orientation_randomness.images.
          path=image_path
      %}
    </p>
    <h3>show_glitter</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.show_glitter.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.iridescence.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.iridescence_apply_to.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.iridescence_at_0_incidence.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.iridescence_at_90_incidence.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.iridescence_color_control.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.iridescence_colors.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.iridescence_exponent.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.iridescence_flip_hue_direction.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.iridescence_interpolations.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.iridescence_positions.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.iridescence_primary_color.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.iridescence_ramp_interpolation_mode.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.iridescence_secondary_color.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.iridescence_thickness.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.input_normal.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.input_normal_dial.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.normal_AA_dial.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.normal_AA_strategy.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.anisotropy.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.metallic_color.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.metallic_edge_color.images.
          path=image_path
      %}
    </p>
    <h3>roughness</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.roughness.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.shading_tangent.images.
          path=image_path
      %}
    </p>
    <h3>show_specular</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.show_specular.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.specular_model.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.extra_aovs.images.
          path=image_path
      %}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.label.images.
          path=image_path
      %}
    </p>
    <h3>priority</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.dwa.DwaMetalMaterial.attributes.priority.images.
          path=image_path
      %}
    </p>
  </p>
