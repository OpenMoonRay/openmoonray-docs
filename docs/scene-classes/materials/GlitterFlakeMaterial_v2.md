...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.approximate_glitter_for_secondary_rays.links-%}
    </p>
    <h3>debug_mode</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.debug_mode.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.dense_glitter_LOD_quality.links-%}
    </p>
    <h3>glitter_mask</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.glitter_mask.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.decouple_flake_size.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_color_hue_variation.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_color_saturation_variation.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_color_value_variation.links-%}
    </p>
    <h3>flake_density</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_density.links-%}
    </p>
    <h3>flake_jitter</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_jitter.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_orientation_randomness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_randomness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_texture_1.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_texture_1_frequency.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_texture_2.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_texture_2_frequency.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.use_flake_textures.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.presence.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.compensate_reference_space_deformation.links-%}
    </p>
    <h3>seed</h3>
    <p class="scene-class-type">
      <b>Int</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.seed.links-%}
    </p>
    <h3>space</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.space.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_color_A.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_roughness_A.links-%}
    </p>
    <h3>flake_size_A</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_size_A.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_style_A_frequency.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_color_B.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_roughness_B.links-%}
    </p>
    <h3>flake_size_B</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_size_B.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.flake_style_B_frequency.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.layering_mode.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.under_material.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.extra_aovs.links-%}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.label.links-%}
    </p>
    <h3>priority</h3>
    <p class="scene-class-type">
      <b>Int</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.GlitterFlakeMaterial_v2.attributes.priority.links-%}
    </p>
  </p>
</details>
</div>