...
---
# UsdPreviewSurface
{%assign image_path=site.data.scene-classes.materials.UsdPreviewSurface.images.path%}
{%if site.data.scene-classes.materials.UsdPreviewSurface.images.gallery-%}
---
## Gallery
{% include image-gallery.html
    images=site.data.scene-classes.materials.UsdPreviewSurface.images.gallery
    path=image_path
%}
{%endif%}
{%if site.data.scene-classes.materials.UsdPreviewSurface.links-%}
---
## See Also
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.clearcoat
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.clearcoatRoughness
          path=image_path
      %}
    </p>
    <h3>diffuseColor</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.diffuseColor
          path=image_path
      %}
    </p>
    <h3>displacement</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.displacement
          path=image_path
      %}
    </p>
    <h3>emissiveColor</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.emissiveColor
          path=image_path
      %}
    </p>
    <h3>extra_aovs</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.extra_aovs
          path=image_path
      %}
    </p>
    <h3>ior</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.ior
          path=image_path
      %}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.label
          path=image_path
      %}
    </p>
    <h3>metallic</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.metallic
          path=image_path
      %}
    </p>
    <h3>normal</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.normal
          path=image_path
      %}
    </p>
    <h3>occlusion</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.occlusion
          path=image_path
      %}
    </p>
    <h3>opacity</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.opacity
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.opacityThreshold
          path=image_path
      %}
    </p>
    <h3>priority</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.priority
          path=image_path
      %}
    </p>
    <h3>roughness</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.roughness
          path=image_path
      %}
    </p>
    <h3>specularColor</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.specularColor
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.images.attributes.useSpecularWorkflow
          path=image_path
      %}
    </p>
  </p>
