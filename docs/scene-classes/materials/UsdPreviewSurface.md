...
# UsdPreviewSurface
---
{%assign image_dir=site.data.scene-classes.materials.UsdPreviewSurface.image_dir%}
<div class="scene-class">
{% include image-gallery.html
    images=site.data.scene-classes.materials.UsdPreviewSurface.gallery
    image_dir=image_dir
%}
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.clearcoat
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.clearcoatRoughness
          image_dir=image_dir
      %}
    </p>
    <h3>diffuseColor</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.diffuseColor
          image_dir=image_dir
      %}
    </p>
    <h3>displacement</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.displacement
          image_dir=image_dir
      %}
    </p>
    <h3>emissiveColor</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.emissiveColor
          image_dir=image_dir
      %}
    </p>
    <h3>extra_aovs</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.extra_aovs
          image_dir=image_dir
      %}
    </p>
    <h3>ior</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.ior
          image_dir=image_dir
      %}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.label
          image_dir=image_dir
      %}
    </p>
    <h3>metallic</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.metallic
          image_dir=image_dir
      %}
    </p>
    <h3>normal</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.normal
          image_dir=image_dir
      %}
    </p>
    <h3>occlusion</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.occlusion
          image_dir=image_dir
      %}
    </p>
    <h3>opacity</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.opacity
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.opacityThreshold
          image_dir=image_dir
      %}
    </p>
    <h3>priority</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.priority
          image_dir=image_dir
      %}
    </p>
    <h3>roughness</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.roughness
          image_dir=image_dir
      %}
    </p>
    <h3>specularColor</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.specularColor
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.UsdPreviewSurface.useSpecularWorkflow
          image_dir=image_dir
      %}
    </p>
  </p>
