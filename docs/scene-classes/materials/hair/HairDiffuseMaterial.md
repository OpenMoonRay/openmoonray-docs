...
---
# HairDiffuseMaterial
{%assign image_path=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.path%}
{%if site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.gallery-%}
---
## Gallery
{% include image-gallery.html
    images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.gallery
    path=image_path
%}
{%endif%}
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.back_hair_color
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.front_hair_color
          path=image_path
      %}
    </p>
    <h3>sss_trace_set</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.sss_trace_set
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.use_independent_front_and_back_hair_color
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.casts_caustics
          path=image_path
      %}
    </p>
    <h3>presence</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.presence
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.emission
          path=image_path
      %}
    </p>
    <h3>show_emission</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.show_emission
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.bssrdf
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.enable_sss_input_normal
          path=image_path
      %}
    </p>
    <h3>input_normal</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.input_normal
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.input_normal_dial
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.scattering_color
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.scattering_radius
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.subsurface_blend
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.extra_aovs
          path=image_path
      %}
    </p>
    <h3>hair_color</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.hair_color
          path=image_path
      %}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.label
          path=image_path
      %}
    </p>
    <h3>priority</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.materials.hair.HairDiffuseMaterial.images.attributes.priority
          path=image_path
      %}
    </p>
  </p>
