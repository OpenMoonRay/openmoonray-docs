...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.back_hair_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.front_hair_color.links-%}
    </p>
    <h3>sss_trace_set</h3>
    <p class="scene-class-type">
      <b>Traceset</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.sss_trace_set.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.use_independent_front_and_back_hair_color.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.casts_caustics.links-%}
    </p>
    <h3>presence</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.presence.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.emission.links-%}
    </p>
    <h3>show_emission</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.show_emission.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.bssrdf.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.enable_sss_input_normal.links-%}
    </p>
    <h3>input_normal</h3>
    <p class="scene-class-type">
      <b>33554432</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.input_normal.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.input_normal_dial.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.scattering_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.scattering_radius.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.subsurface_blend.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.extra_aovs.links-%}
    </p>
    <h3>hair_color</h3>
    <p class="scene-class-type">
      <b>Rgb</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.hair_color.links-%}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.label.links-%}
    </p>
    <h3>priority</h3>
    <p class="scene-class-type">
      <b>Int</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairDiffuseMaterial.attributes.priority.links-%}
    </p>
  </p>
</details>
</div>