...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.back_hair_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.front_hair_color.links-%}
    </p>
    <h3>sss_trace_set</h3>
    <p class="scene-class-type">
      <b>Traceset</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.sss_trace_set.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.use_independent_front_and_back_hair_color.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.presence.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.hair_color.links-%}
    </p>
    <h3>hair_diffuse</h3>
    <p class="scene-class-type">
      <b>Float</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.hair_diffuse.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.show_hair_diffuse.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.emission.links-%}
    </p>
    <h3>show_emission</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.show_emission.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_enable_indirect_reflections.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_enable_input_normal.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_indirect_reflections_intensity.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_indirect_reflections_roughness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_input_U.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_input_V.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_input_normal.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_input_normal_dial.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_intensity.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_interpolations.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_model.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_positions.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_roughness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_show.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_stretch_u.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_stretch_v.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_tint.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_use_input_vectors_for_stretch.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_1_values.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_enable_indirect_reflections.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_enable_input_normal.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_indirect_reflections_intensity.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_indirect_reflections_roughness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_input_U.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_input_V.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_input_normal.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_input_normal_dial.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_intensity.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_interpolations.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_model.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_positions.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_roughness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_show.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_stretch_u.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_stretch_v.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_tint.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_use_input_vectors_for_stretch.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_2_values.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_enable_indirect_reflections.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_enable_input_normal.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_indirect_reflections_intensity.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_indirect_reflections_roughness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_input_U.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_input_V.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_input_normal.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_input_normal_dial.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_intensity.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_interpolations.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_model.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_positions.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_roughness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_show.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_stretch_u.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_stretch_v.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_tint.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_use_input_vectors_for_stretch.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.specular_3_values.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.bssrdf.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.enable_sss_input_normal.links-%}
    </p>
    <h3>input_normal</h3>
    <p class="scene-class-type">
      <b>33554432</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.input_normal.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.input_normal_dial.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.scattering_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.scattering_radius.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.subsurface_blend.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.extra_aovs.links-%}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.label.links-%}
    </p>
    <h3>priority</h3>
    <p class="scene-class-type">
      <b>Int</b>
      ...
      {%include see-also.html links=site.data.scene-classes.materials.hair.HairToonMaterial.attributes.priority.links-%}
    </p>
  </p>
</details>
</div>