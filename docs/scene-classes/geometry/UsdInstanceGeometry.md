...
---
# UsdInstanceGeometry
{%assign image_path=site.data.scene-classes.geometry.UsdInstanceGeometry.image_path%}
{%if site.data.scene-classes.geometry.UsdInstanceGeometry.gallery-%}
---
## Gallery
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.curved_motion_blur_sample_count.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.disable_indices.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.evaluation_frame.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.instance_level.images.
          path=image_path
      %}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.label.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.motion_blur_type.images.
          path=image_path
      %}
    </p>
    <h3>node_xform</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.node_xform.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.point_instancer_path.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.primitive_attribute_frame.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.primitive_attributes.images.
          path=image_path
      %}
    </p>
    <h3>ray_epsilon</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.ray_epsilon.images.
          path=image_path
      %}
    </p>
    <h3>references</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.references.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.reverse_normals.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.shadow_exclusion_mappings.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.shadow_ray_epsilon.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.shadow_receiver_label.images.
          path=image_path
      %}
    </p>
    <h3>side_type</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.side_type.images.
          path=image_path
      %}
    </p>
    <h3>stage</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.stage.images.
          path=image_path
      %}
    </p>
    <h3>static</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.static.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.use_evaluation_frame.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.use_reference_attributes.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.use_reference_xforms.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.use_rotation_motion_blur.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.use_stage_cache.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.visible_diffuse_reflection.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.visible_diffuse_transmission.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.visible_glossy_reflection.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.visible_glossy_transmission.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.visible_in_camera.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.visible_mirror_reflection.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.visible_mirror_transmission.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.visible_shadow.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.geometry.UsdInstanceGeometry.attributes.visible_volume.images.
          path=image_path
      %}
    </p>
  </p>
