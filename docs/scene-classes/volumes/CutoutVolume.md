...
---
# CutoutVolume
{%assign image_path=site.data.scene-classes.volumes.CutoutVolume.images.path%}
{%if site.data.scene-classes.volumes.CutoutVolume.images.gallery-%}
---
## Gallery
{% include image-gallery.html
    images=site.data.scene-classes.volumes.CutoutVolume.images.gallery
    path=image_path
%}
{%endif%}
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.CutoutVolume.images.attributes.bake_divisions
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.CutoutVolume.images.attributes.bake_resolution_mode
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.CutoutVolume.images.attributes.bake_voxel_size
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.CutoutVolume.images.attributes.indirect_volume
          path=image_path
      %}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.CutoutVolume.images.attributes.label
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.CutoutVolume.images.attributes.surface_opacity_threshold
          path=image_path
      %}
    </p>
  </p>
