...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.CutoutVolume.attributes.bake_divisions.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.CutoutVolume.attributes.bake_resolution_mode.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.CutoutVolume.attributes.bake_voxel_size.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.CutoutVolume.attributes.indirect_volume.links-%}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.CutoutVolume.attributes.label.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.CutoutVolume.attributes.surface_opacity_threshold.links-%}
    </p>
  </p>
</details>
</div>