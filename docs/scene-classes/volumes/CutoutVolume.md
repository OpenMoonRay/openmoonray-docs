...
# CutoutVolume
---
{%assign image_dir=site.data.scene-classes.volumes.CutoutVolume.image_dir%}
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.CutoutVolume.bake_divisions
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.CutoutVolume.bake_resolution_mode
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.CutoutVolume.bake_voxel_size
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.CutoutVolume.indirect_volume
          image_dir=image_dir
      %}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.CutoutVolume.label
          image_dir=image_dir
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.CutoutVolume.surface_opacity_threshold
          image_dir=image_dir
      %}
    </p>
  </p>
