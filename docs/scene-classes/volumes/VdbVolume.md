...
---
# VdbVolume
{%assign image_path=site.data.scene-classes.volumes.VdbVolume.image_path%}
{%if site.data.scene-classes.volumes.VdbVolume.gallery-%}
---
## Gallery
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.VdbVolume.attributes.anisotropy.images.
          path=image_path
      %}
    </p>
    <h3>color_mult</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.VdbVolume.attributes.color_mult.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.VdbVolume.attributes.incandescence_gain_mult.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.VdbVolume.attributes.opacity_gain_mult.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.VdbVolume.attributes.bake_divisions.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.VdbVolume.attributes.bake_resolution_mode.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.VdbVolume.attributes.bake_voxel_size.images.
          path=image_path
      %}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.VdbVolume.attributes.label.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.volumes.VdbVolume.attributes.surface_opacity_threshold.images.
          path=image_path
      %}
    </p>
  </p>
