...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.emission_color.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.emission_intensity.links heading=4-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.anisotropy.links heading=4-%}
    </p>
    <h3>diffuse_color</h3>
    <p class="scene-class-type">
      <b>Rgb</b> <i>bindable</i>
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.diffuse_color.links heading=4-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.bake_divisions.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.bake_resolution_mode.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.bake_voxel_size.links heading=4-%}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.label.links heading=4-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.surface_opacity_threshold.links heading=4-%}
    </p>
  </p>
</details>
</div>