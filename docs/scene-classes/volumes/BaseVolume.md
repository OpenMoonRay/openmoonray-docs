...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.attenuation_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.attenuation_intensity.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include image-gallery.html images=site.data.scene-classes.volumes.BaseVolume.attributes.emission_color.images data=site.data.scene-classes.volumes.BaseVolume-%}
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.emission_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include image-gallery.html images=site.data.scene-classes.volumes.BaseVolume.attributes.emission_intensity.images data=site.data.scene-classes.volumes.BaseVolume-%}
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.emission_intensity.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include image-gallery.html images=site.data.scene-classes.volumes.BaseVolume.attributes.anisotropy.images data=site.data.scene-classes.volumes.BaseVolume-%}
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.anisotropy.links-%}
    </p>
    <h3>diffuse_color</h3>
    <p class="scene-class-type">
      <b>Rgb</b> <i>bindable</i>
      ...
      {%include image-gallery.html images=site.data.scene-classes.volumes.BaseVolume.attributes.diffuse_color.images data=site.data.scene-classes.volumes.BaseVolume-%}
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.diffuse_color.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include image-gallery.html images=site.data.scene-classes.volumes.BaseVolume.attributes.bake_divisions.images data=site.data.scene-classes.volumes.BaseVolume-%}
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.bake_divisions.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include image-gallery.html images=site.data.scene-classes.volumes.BaseVolume.attributes.bake_resolution_mode.images data=site.data.scene-classes.volumes.BaseVolume-%}
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.bake_resolution_mode.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include image-gallery.html images=site.data.scene-classes.volumes.BaseVolume.attributes.bake_voxel_size.images data=site.data.scene-classes.volumes.BaseVolume-%}
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.bake_voxel_size.links-%}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include image-gallery.html images=site.data.scene-classes.volumes.BaseVolume.attributes.label.images data=site.data.scene-classes.volumes.BaseVolume-%}
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.label.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include image-gallery.html images=site.data.scene-classes.volumes.BaseVolume.attributes.surface_opacity_threshold.images data=site.data.scene-classes.volumes.BaseVolume-%}
      {%include see-also.html links=site.data.scene-classes.volumes.BaseVolume.attributes.surface_opacity_threshold.links-%}
    </p>
  </p>
</details>
</div>