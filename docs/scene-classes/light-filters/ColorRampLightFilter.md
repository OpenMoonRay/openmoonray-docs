...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.light-filters.ColorRampLightFilter.attributes.begin_distance.links-%}
    </p>
    <h3>colors</h3>
    <p class="scene-class-type">
      <b>RgbVector</b>
      ...
      {%include see-also.html links=site.data.scene-classes.light-filters.ColorRampLightFilter.attributes.colors.links-%}
    </p>
    <h3>density</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.light-filters.ColorRampLightFilter.attributes.density.links-%}
    </p>
    <h3>distances</h3>
    <p class="scene-class-type">
      <b>FloatVector</b>
      ...
      {%include see-also.html links=site.data.scene-classes.light-filters.ColorRampLightFilter.attributes.distances.links-%}
    </p>
    <h3>end_distance</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.light-filters.ColorRampLightFilter.attributes.end_distance.links-%}
    </p>
    <h3>intensity</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.light-filters.ColorRampLightFilter.attributes.intensity.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.light-filters.ColorRampLightFilter.attributes.interpolation_types.links-%}
    </p>
    <h3>mode</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.light-filters.ColorRampLightFilter.attributes.mode.links-%}
    </p>
    <h3>node_xform</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.light-filters.ColorRampLightFilter.attributes.node_xform.links-%}
    </p>
    <h3>wrap_mode</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.light-filters.ColorRampLightFilter.attributes.wrap_mode.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.light-filters.ColorRampLightFilter.attributes.on.links-%}
    </p>
    <h3>use_xform</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.light-filters.ColorRampLightFilter.attributes.use_xform.links-%}
    </p>
  </p>
</details>
</div>