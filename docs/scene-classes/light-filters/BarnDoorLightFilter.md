...
---
# BarnDoorLightFilter
{%assign image_path=site.data.scene-classes.light-filters.BarnDoorLightFilter.image_path%}
{%if site.data.scene-classes.light-filters.BarnDoorLightFilter.gallery-%}
---
## Gallery
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.color.images.
          path=image_path
      %}
    </p>
    <h3>density</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.density.images.
          path=image_path
      %}
    </p>
    <h3>edge</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.edge.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.edge_scale_bottom.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.edge_scale_left.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.edge_scale_right.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.edge_scale_top.images.
          path=image_path
      %}
    </p>
    <h3>invert</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.invert.images.
          path=image_path
      %}
    </p>
    <h3>mode</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.mode.images.
          path=image_path
      %}
    </p>
    <h3>node_xform</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.node_xform.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.pre_barn_distance.images.
          path=image_path
      %}
    </p>
    <h3>pre_barn_mode</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.pre_barn_mode.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.projector_focal_distance.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.projector_height.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.projector_type.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.projector_width.images.
          path=image_path
      %}
    </p>
    <h3>radius</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.radius.images.
          path=image_path
      %}
    </p>
    <h3>rotation</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.rotation.images.
          path=image_path
      %}
    </p>
    <h3>size_bottom</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.size_bottom.images.
          path=image_path
      %}
    </p>
    <h3>size_left</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.size_left.images.
          path=image_path
      %}
    </p>
    <h3>size_right</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.size_right.images.
          path=image_path
      %}
    </p>
    <h3>size_top</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.size_top.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.use_light_xform.images.
          path=image_path
      %}
    </p>
  </p>
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.light-filters.BarnDoorLightFilter.attributes.on.images.
          path=image_path
      %}
    </p>
  </p>
