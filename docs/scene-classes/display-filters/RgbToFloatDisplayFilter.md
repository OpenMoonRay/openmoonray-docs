...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.display-filters.RgbToFloatDisplayFilter.attributes.invert_mask.links-%}
    </p>
    <h3>mix</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.display-filters.RgbToFloatDisplayFilter.attributes.mix.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.display-filters.RgbToFloatDisplayFilter.attributes.input.links-%}
    </p>
    <h3>mask</h3>
    <p class="scene-class-type">
      <b>67141632</b>
      ...
      {%include see-also.html links=site.data.scene-classes.display-filters.RgbToFloatDisplayFilter.attributes.mask.links-%}
    </p>
    <h3>mode</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.display-filters.RgbToFloatDisplayFilter.attributes.mode.links-%}
    </p>
  </p>
</details>
</div>