...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.display-filters.ClampDisplayFilter.attributes.invert_mask.links-%}
    </p>
    <h3>mix</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.display-filters.ClampDisplayFilter.attributes.mix.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.display-filters.ClampDisplayFilter.attributes.input.links-%}
    </p>
    <h3>mask</h3>
    <p class="scene-class-type">
      <b>67141632</b>
      ...
      {%include see-also.html links=site.data.scene-classes.display-filters.ClampDisplayFilter.attributes.mask.links-%}
    </p>
    <h3>max</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%include see-also.html links=site.data.scene-classes.display-filters.ClampDisplayFilter.attributes.max.links-%}
    </p>
    <h3>min</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%include see-also.html links=site.data.scene-classes.display-filters.ClampDisplayFilter.attributes.min.links-%}
    </p>
  </p>
</details>
</div>