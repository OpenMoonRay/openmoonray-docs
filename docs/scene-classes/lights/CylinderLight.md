...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.contrast.links-%}
    </p>
    <h3>gain</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.gain.links-%}
    </p>
    <h3>gamma</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.gamma.links-%}
    </p>
    <h3>offset</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.offset.links-%}
    </p>
    <h3>saturation</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.saturation.links-%}
    </p>
    <h3>temperature</h3>
    <p class="scene-class-type">
      <b>Vec3f</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.temperature.links-%}
    </p>
    <h3>texture</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.texture.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.texture_border_color.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.texture_coverage.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.texture_mirror_u.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.texture_mirror_v.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.texture_reps_u.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.texture_reps_v.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.texture_rotation.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.texture_translation.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.apply_scene_scale.links-%}
    </p>
    <h3>clear_radius</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.clear_radius.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.clear_radius_falloff_distance.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.clear_radius_interpolation_type.links-%}
    </p>
    <h3>color</h3>
    <p class="scene-class-type">
      <b>Rgb</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.color.links-%}
    </p>
    <h3>exposure</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.exposure.links-%}
    </p>
    <h3>height</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.height.links-%}
    </p>
    <h3>intensity</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.intensity.links-%}
    </p>
    <h3>label</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.label.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.max_shadow_distance.links-%}
    </p>
    <h3>mb</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.mb.links-%}
    </p>
    <h3>normalized</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.normalized.links-%}
    </p>
    <h3>on</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.on.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.presence_shadows.links-%}
    </p>
    <h3>radius</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.radius.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.ray_termination.links-%}
    </p>
    <h3>sidedness</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.sidedness.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.texture_filter.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.visible_in_camera.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.visible_diffuse_reflection.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.visible_diffuse_transmission.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.visible_glossy_reflection.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.visible_glossy_transmission.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.visible_mirror_reflection.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.visible_mirror_transmission.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.light_filters.links-%}
    </p>
    <h3>node_xform</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.lights.CylinderLight.attributes.node_xform.links-%}
    </p>
  </p>
</details>
</div>