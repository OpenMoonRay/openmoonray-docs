...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.active.images.
          path=image_path
      %}
    </p>
    <h3>camera</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.camera.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.channel_format.images.
          path=image_path
      %}
    </p>
    <h3>channel_name</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.channel_name.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.channel_suffix_mode.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.checkpoint_file_name.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.checkpoint_multi_version_file_name.images.
          path=image_path
      %}
    </p>
    <h3>compression</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.compression.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.cryptomatte_depth.images.
          path=image_path
      %}
    </p>
    <h3>denoise</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.denoise.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.denoiser_input.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.display_filter.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.exr_dwa_compression_level.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.exr_header_attributes.images.
          path=image_path
      %}
    </p>
    <h3>file_name</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.file_name.images.
          path=image_path
      %}
    </p>
    <h3>file_part</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.file_part.images.
          path=image_path
      %}
    </p>
    <h3>lpe</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.lpe.images.
          path=image_path
      %}
    </p>
    <h3>material_aov</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.material_aov.images.
          path=image_path
      %}
    </p>
    <h3>math_filter</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.math_filter.images.
          path=image_path
      %}
    </p>
    <h3>output_type</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.output_type.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.primitive_attribute.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.primitive_attribute_type.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.reference_render_output.images.
          path=image_path
      %}
    </p>
    <h3>result</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.result.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.resume_file_name.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.state_variable.images.
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutputattributes.visibility_aov.images.
          path=image_path
      %}
    </p>
  </p>
