...
---
# RenderOutput
{%assign image_path=site.data.scene-classes.render-output.RenderOutput.images.path%}
{%if site.data.scene-classes.render-output.RenderOutput.images.gallery-%}
---
## Gallery
{% include image-gallery.html
    images=site.data.scene-classes.render-output.RenderOutput.images.gallery
    path=image_path
%}
{%endif%}
{%if site.data.scene-classes.render-output.RenderOutput.links-%}
---
## See Also
...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.active
          path=image_path
      %}
    </p>
    <h3>camera</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.camera
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.channel_format
          path=image_path
      %}
    </p>
    <h3>channel_name</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.channel_name
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.channel_suffix_mode
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.checkpoint_file_name
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.checkpoint_multi_version_file_name
          path=image_path
      %}
    </p>
    <h3>compression</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.compression
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.cryptomatte_depth
          path=image_path
      %}
    </p>
    <h3>denoise</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.denoise
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.denoiser_input
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.display_filter
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.exr_dwa_compression_level
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.exr_header_attributes
          path=image_path
      %}
    </p>
    <h3>file_name</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.file_name
          path=image_path
      %}
    </p>
    <h3>file_part</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.file_part
          path=image_path
      %}
    </p>
    <h3>lpe</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.lpe
          path=image_path
      %}
    </p>
    <h3>material_aov</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.material_aov
          path=image_path
      %}
    </p>
    <h3>math_filter</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.math_filter
          path=image_path
      %}
    </p>
    <h3>output_type</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.output_type
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.primitive_attribute
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.primitive_attribute_type
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.reference_render_output
          path=image_path
      %}
    </p>
    <h3>result</h3>
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.result
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.resume_file_name
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.state_variable
          path=image_path
      %}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {% include image-gallery.html
          images=site.data.scene-classes.render-output.RenderOutput.images.attributes.visibility_aov
          path=image_path
      %}
    </p>
  </p>
