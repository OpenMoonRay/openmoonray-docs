...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.active.links-%}
    </p>
    <h3>camera</h3>
    <p class="scene-class-type">
      <b>Camera</b>
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.camera.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.channel_format.links-%}
    </p>
    <h3>channel_name</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.channel_name.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.channel_suffix_mode.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.checkpoint_file_name.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.checkpoint_multi_version_file_name.links-%}
    </p>
    <h3>compression</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.compression.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.cryptomatte_depth.links-%}
    </p>
    <h3>denoise</h3>
    <p class="scene-class-type">
      <b>Bool</b>
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.denoise.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.denoiser_input.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.display_filter.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.exr_dwa_compression_level.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.exr_header_attributes.links-%}
    </p>
    <h3>file_name</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.file_name.links-%}
    </p>
    <h3>file_part</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.file_part.links-%}
    </p>
    <h3>lpe</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.lpe.links-%}
    </p>
    <h3>material_aov</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.material_aov.links-%}
    </p>
    <h3>math_filter</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.math_filter.links-%}
    </p>
    <h3>output_type</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.output_type.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.primitive_attribute.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.primitive_attribute_type.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.reference_render_output.links-%}
    </p>
    <h3>result</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.result.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.resume_file_name.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.state_variable.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.render-output.RenderOutput.attributes.visibility_aov.links-%}
    </p>
  </p>
</details>
</div>