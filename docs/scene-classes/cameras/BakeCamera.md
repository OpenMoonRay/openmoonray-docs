...
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.far.links-%}
    </p>
    <h3>near</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.near.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.mb_shutter_bias.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.mb_shutter_close.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.mb_shutter_open.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.pixel_sample_map.links-%}
    </p>
  </p>
</details>
<details open>
  ...
  <p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.bias.links-%}
    </p>
    <h3>geometry</h3>
    <p class="scene-class-type">
      <b>Geometry</b>
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.geometry.links-%}
    </p>
    <h3>map_factor</h3>
    <p class="scene-class-type">
      <b>Float</b>
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.map_factor.links-%}
    </p>
    <h3>mode</h3>
    <p class="scene-class-type">
      <b>Int</b> <i>enum</i>
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.mode.links-%}
    </p>
    <h3>node_xform</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.node_xform.links-%}
    </p>
    <h3>normal_map</h3>
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.normal_map.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.normal_map_space.links-%}
    </p>
    <h3>udim</h3>
    <p class="scene-class-type">
      <b>Int</b>
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.udim.links-%}
    </p>
    ...
    <p class="scene-class-type">
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.use_relative_bias.links-%}
    </p>
    <h3>uv_attribute</h3>
    <p class="scene-class-type">
      <b>String</b>
      ...
      {%include see-also.html links=site.data.scene-classes.cameras.BakeCamera.attributes.uv_attribute.links-%}
    </p>
  </p>
</details>
</div>