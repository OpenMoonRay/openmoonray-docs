...
<details open>
  ...
  <p>
    ...
    <i>enum</i>
        ...
        <p class=jekyll-theme-minimal scene-class-attr-comment">for testing</p>
    ...
    <b>Bool</b>
        ...
        <p class=jekyll-theme-minimal scene-class-attr-comment">Project onto reference positions ('ref_P') and normals ('ref_N')</p>
