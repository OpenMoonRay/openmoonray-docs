...
<details open>
  ...
  <p>
    ...
    <p>Bind the root of a map shader network that you want evaluated as an extra aov</p>
    ...
    <p>Sets the LPE label that is used for the extra aov</p>
