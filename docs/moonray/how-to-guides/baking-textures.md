...
See the [BakeCamera]({{site.baseurl}}/scene-classes/cameras/BakeCamera) class reference for the
...
![]({{site.baseurl}}/assets/images/moonray/how-to-guides/baking-textures/sphere2.png)
