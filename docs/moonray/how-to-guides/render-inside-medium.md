...
| --------------------- | ----------------------------------------- |
| ![Medium Material None Example](../../assets/images/moonray/how-to-guides/render-in-medium/medium_material_none.png) | ![Medium Material Water Example](../../assets/images/moonray/how-to-guides/render-in-medium/medium_material_refractive.png) |
