...
<details open>
  ...
  <p>
    ...
    <b>Float</b>
        ...
        <p class="jekyll-theme-minimal scene-class-attr-comment">directionality of light emission. 1 is completely diffuse hemisphere. 0 is parallel to normal of light.</p>
