...
> The RenderOutput object is used to specif y any output the renderer
> produces. It has a lot of options. For the most up to da te set of
> options ty pe
>
> rdl2_print RenderOutput
>
> In y our command shell. What f ollows on this page are some simple
> examples and links to other, more specif ic docs.
...
> }
>
> RenderOutput(\"/output/result0/alpha\") { \[\"file name\"\] =
> \"result0.exr\", \[\"result\"\] = 1 \-- alpha
>
> }
>
> RenderOutput(\"/output/result0/depth\") { \[\"file name\"\] =
> \"result0.exr\", \[\"result\"\] = 2, \-- depth
>
> \[\"channel format\"\] = 0, \-- 32 bit float \[\"math filter\"\] =
> \"min\"
>
> }
...
>
> \[\"file name\"\] = \"result0.exr\", \[\"result\"\] = 3, \-- state
> variable \[\"state variable\"\] = 10, \-- \"WP\" \[\"channel
> format\"\] = 0
>
> }
...
>
> \[\"file name\"\] = \"result0.exr\", \[\"result\"\] = 4, \-- primitive
> attribute \[\"primitive attribute\"\] = \"ref_P\",
>
...
> \[\"file name\"\] = \"result0.exr\",
>
> \[\"result\"\] = 7, \-- material aov \[\"material aov\"\] =
> \"G.color\",
>
> }

###### Matte of the Geometry Objects w ith the \"curly\" and \"gizmo1\' Labels
...
>
> \[\"file name\"\] = \"result0.exr\", \[\"result\"\] = 8, \-- light aov
>
> \[\"light aov\"\] = \"CGL\", \[\"channel format\"\] = 0,
>
> }
...
> For more details see: Motion Vectors
>
> \-- Create 2D screen space motion vectors
> RenderOutput(\"/output/motion_vectors\") {
>
> \[\"result\"\] = \"material aov\", \[\"material_aov\"\] =
> \"motionvec\", \[\"channel_suffix_mode\"\] = \"rgb\"
