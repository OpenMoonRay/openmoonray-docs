...
(see [Building MoonRay in a container]({{ "/getting-started/installation/building-moonray/building-moonray-container))" | absolute_url }})).
...
> yum install -y bison flex  wget git python3 python3-devel patch.mp4lib-devel libmng libtiff-devel libjpeg-devel libatomic libcgroup-devel libuuid-devel openssl-devel curl-devel
