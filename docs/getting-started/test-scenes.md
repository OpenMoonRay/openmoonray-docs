...
This is the basis of the [texture cache profiling page]({{ "/user-reference/alab/textureCacheSize/" | absolute_url }}).  Useful information is in the moonray.memo for rendering, aong with a file middleQualityUniformHD.rdla for a middle-quality rendering setup.
